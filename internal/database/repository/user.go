...
func (h *user_handler) FindAll() []database_model.User {
...
func (h *user_handler) Create(user database_model.User) bool {
	now := time.Now().Unix()
...
func (h *user_handler) Update(user database_model.User) bool {
	now := time.Now().Unix()
	user.UpdatedAt = uint64(now);
...
func (h *user_handler) Remove(user database_model.User) bool {
...
func (h *user_handler) FindById(id uint64) database_model.User {
...
func (h *user_handler) FindByEmail(email string) database_model.User {
